  ...
  return (
    ...
    (et.cloneElement = function (v, H, X) {
      ...
      if (I === 1) Y.children = X;
        ...
        for (var ae = Array(I), bt = 0; bt < I; bt++)
        ...
        function dt(z) {
          for (var G = o(m); G !== null; ) {
            if (G.callback === null) r(m);
              ...
              (r(m), (G.sortIndex = G.expirationTime), s(p, G));
            else break;
            G = o(m);
          }
        }
...
function Lv() {
  ...
  function Yu(t) {
    (ct.current === t && (X(K), X(ct)),
      ae.current === t && (X(ae), (Ru._currentValue = k)));
  }
...
` +
        ...
        !l.hasOwnProperty(a) ||
          ...
          (a.indexOf('--') === 0
            ...
            : a === 'float'
              ...
              : (t[a] = ''));
      for (var u in e)
        ((a = e[u]), e.hasOwnProperty(u) && l[u] !== a && nr(t, u, a));
  ...
  function ye(t, e) {
    if (typeof t == 'object' && t !== null) {
      ...
      return l !== void 0
        ? l
        : ((e = { value: t, source: e, stack: If(e) }), qr.set(t, e), e);
    }
  ...
  function Vi(t) {
    for (; t === un; )
      ((un = ia[--ca]), (ia[ca] = null), (nn = ia[--ca]), (ia[ca] = null));
    for (; t === Nl; )
      ((Nl = Se[--pe]),
        (Se[pe] = null),
        (Ye = Se[--pe]),
  ...
  function Lr() {
    ...
    return (
      t !== null &&
        (le === null ? (le = t) : le.push.apply(le, t), (Cl = null)),
      t
    );
  }
  function ka(t) {
          ...
          t: {
            ...
            switch (J.tag) {
              ...
              case 0:
                if (
                  ((W = J.payload),
                  (E = typeof W == 'function' ? W.call(vt, N, E) : W),
                  E == null)
                )
                  break t;
                N = x({}, N, E);
  ...
  function ls(t) {
    ...
    if (((il = 0), (Ct = ht = lt = null), (hn = !1), (uu = 0), (da = null), e))
      throw Error(r(300));
    t === null ||
      Yt ||
      ((t = t.dependencies), t !== null && cn(t) && (Yt = !0));
  }
  function as(t, e, l, a) {
    lt = t;
    var u = 0;
  ...
  function nu(t) {
    ...
    return (
      ...
      (Ct === null ? e.memoizedState : Ct.next) === null &&
        ((e = e.alternate),
        (z.H = e === null || e.memoizedState === null ? Ys : Gs)),
      t
    );
  }
  function vn(t) {
  ...
  function us(t, e, l) {
    ...
    if (
      ...
      if (
        ((a.flags |= 2048),
        ha(9, gn(), is.bind(null, a, u, l, e), null),
        St === null)
      )
        throw Error(r(349));
      n || (il & 124) !== 0 || ns(a, e, l);
  ...
  function Ss(t, e, l) {
    ...
    return (
      l !== e.memoizedState &&
        ((lt.flags |= 2048), ha(9, gn(), Mm.bind(null, u, l), null)),
      [a, n, t]
    );
  }
  function Mm(t, e) {
  ...
  function Nm(t, e, l) {
    ...
    ((l = {
      ...
      pn(t)
        ? js(e, l)
        : ((l = Xi(t, e, l, a)), l !== null && (de(l, t, a), qs(l, e, a))));
  }
  function Bs(t, e, l) {
    var a = oe();
    cu(t, e, l, a);
    ...
    Ys = {
      ...
      useImperativeHandle: function (t, e, l) {
        ((l = l != null ? l.concat([t]) : null),
          Sn(4194308, 4, Rs.bind(null, e, t), l));
      },
    ...
    function d(S, y, b, O) {
      ...
      return Q === j
        ...
        : y !== null &&
          ...
          : ((y = an(b.type, b.key, b.props, null, S.mode, O)),
            ru(y, b),
            (y.return = S),
            y);
    }
    ...
    function N(S, y, b) {
      ...
      if (typeof y == 'object' && y !== null) {
        switch (y.$$typeof) {
          case C:
            return (
              (b = an(y.type, y.key, y.props, null, S.mode, b)),
              ru(b, y),
              (b.return = S),
              b
            );
        ...
        if (Kt(y) || Vt(y))
          return ((y = Ol(y, S.mode, b, null)), (y.return = S), y);
    ...
    function T(S, y, b, O, Q) {
      ...
      if (typeof O == 'object' && O !== null) {
        switch (O.$$typeof) {
          case C:
            return (
              (S = S.get(O.key === null ? b : O.key) || null),
              d(y, S, O, Q)
            );
          case L:
            return (
        ...
        if (Kt(O) || Vt(O))
          return ((S = S.get(b) || null), R(y, S, O, Q, null));
        ...
        switch (b.$$typeof) {
          case C:
            t: {
              ...
              b.type === j
                ? ((O = Ol(b.props.children, S.mode, O, b.key)),
                  (O.return = S),
                  (S = O))
  ...
  function to(t, e, l, a, u) {
    ...
    if (((n = t.child), !Uc(t, u))) {
      ...
      if (
        ((l = l.compare), (l = l !== null ? l : Va), l(i, a) && t.ref === e.ref)
      )
        return Le(t, e, u);
    }
    return (
  ...
  function eo(t, e, l, a, u) {
    if (t !== null) {
      ...
      if (Va(n, a) && t.ref === e.ref)
        if (((Yt = !1), (e.pendingProps = a = n), Uc(t, u)))
  ...
  function co(t, e, l) {
    ...
    if (
      ...
      if (n)
        ...
        (Yt || Wa(t, e, l, !1), (i = (l & t.childLanes) !== 0), Yt || i)
      ) {
        if (
          ((i = St),
          i !== null &&
      ...
      ? (fl(),
        ...
        f === null
          ...
          : ((d = f.cachePool),
            d !== null
              ? ((_ = Bt._currentValue),
                (d = d.parent !== _ ? { parent: _, pool: _ } : d))
              : (d = Jr()),
    ...
    switch (((e.lanes = 0), e.tag)) {
      ...
      case 5:
        return (
          ...
          e.memoizedState !== null &&
            ((u = cc(t, e, xm, null, null, l)), (Ru._currentValue = u)),
          xn(t, e),
          Qt(t, e, a, l),
          e.child
        );
        ...
        return (
          t === null &&
            ...
            ((t = l = Rt) &&
              ...
              l !== null
                ? ((e.stateNode = l), (Ft = e), (Rt = null), (t = !0))
                : (t = !1)),
            t || Hl(e)),
          null
        );
  ...
  function Mn(t, e) {
    (e !== null && (t.flags |= 4),
      t.flags & 16384 &&
        ((e = t.tag !== 22 ? Lf() : 536870912), (t.lanes |= e), (pa |= e)));
  }
  function su(t, e) {
    if (!rt)
      switch (t.tailMode) {
    ...
    switch ((Vi(e), e.tag)) {
      ...
      case 26:
        return (
          ...
          t === null
            ? (Ze(e),
              l !== null ? (Et(e), oo(e, l)) : (Et(e), (e.flags &= -16777217)))
            : l
              ? l !== t.memoizedState
                ? (Ze(e), Et(e), oo(e, l))
      ...
      case 27:
        ...
        if (t !== null && e.stateNode != null) t.memoizedProps !== a && Ze(e);
          ...
          ((t = K.current),
            Ja(e) ? wr(e) : ((t = dd(u, a, l)), (e.stateNode = t), Ze(e)));
        }
        return (Et(e), null);
      case 5:
      ...
      case 6:
        if (t && e.stateNode != null) t.memoizedProps !== a && Ze(e);
          ...
          if (((t = I.current), Ja(e))) {
            ...
            ((t = wn(t).createTextNode(a)), (t[Jt] = e), (e.stateNode = t));
        }
        return (Et(e), null);
      case 13:
        if (
  ...
  function Bc(t, e, l) {
    ...
    if (a === 5 || a === 6)
      ...
      a !== 4 &&
      (a === 27 && gl(t.type) && ((l = t.stateNode), (e = null)),
      (t = t.child),
      t !== null)
    )
  ...
  function Dn(t, e, l) {
    ...
    if (a === 5 || a === 6)
      ...
      a !== 4 &&
      (a === 27 && gl(t.type) && (l = t.stateNode), (t = t.child), t !== null)
    )
  ...
  function qm(t, e) {
    ...
    for (
      ff = { focusedElem: t, selectionRange: l }, Jn = !1, Gt = e;
      Gt !== null;
      ...
      case 13:
        (sl(t, l),
          ...
          a & 64 &&
            ...
            t !== null &&
              ((t = t.dehydrated),
              t !== null && ((l = Km.bind(null, l)), sv(t, l)))));
        break;
      case 22:
    ...
    switch (l.tag) {
      ...
      case 1:
        (Ot ||
          (De(l, e),
          (a = l.stateNode),
          typeof a.componentWillUnmount == 'function' && vo(l, e, a)),
          Ke(t, e, l));
        break;
      case 21:
        Ke(t, e, l);
  ...
  function fe(t, e) {
    ...
    if (e.subtreeFlags & 13878)
      for (e = e.child; e !== null; ) (Ao(e, t), (e = e.sibling));
  }
  var Ae = null;
  function Ao(t, e) {
    var l = t.alternate,
    ...
    switch (t.tag) {
      ...
      case 15:
        (fe(e, t),
          re(t),
          a & 4 && (rl(3, t, t.return), ou(3, t), rl(5, t, t.return)));
        break;
      case 1:
        (fe(e, t),
          re(t),
      ...
      case 4:
        ((a = Ae),
          (Ae = Qn(t.stateNode.containerInfo)),
          fe(e, t),
          re(t),
          (Ae = a));
        break;
    ...
    for (t = t.child; t !== null; ) {
      ...
      switch (e.tag) {
        ...
        case 1:
          De(e, e.return);
          var l = e.stateNode;
          (typeof l.componentWillUnmount == 'function' && vo(e, e.return, l),
            Xl(e));
          break;
        case 27:
          _u(e.stateNode);
    ...
    switch (t.tag) {
      case 26:
        (ga(t),
          t.flags & mu &&
            t.memoizedState !== null &&
            Tv(Ae, t.memoizedState, t.memoizedProps));
        break;
      case 5:
        ga(t);
        break;
  ...
  function Ho(t, e, l, a, u, n, i, f, d, _, R, N, E, T) {
    if (
      ...
      (N & 8192 || (N & 16785408) === 16785408) &&
        ((Au = { stylesheets: null, count: 0, unsuspend: Ev }),
        zo(e),
        (N = Av()),
        N !== null))
    ) {
      ((t.cancelPendingCommit = N(
        wo.bind(null, t, e, n, l, a, u, i, f, d, R, 1, E, T),
      )),
        yl(t, n, i, !_));
      return;
    }
  ...
  function Ko() {
    ...
    try {
      ...
      var n = vl,
        i = _a;
      if (((Lt = 0), (ba = vl = null), (_a = 0), (st & 6) !== 0))
        throw Error(r(331));
      var f = st;
      if (
        ((st |= 4),
  ...
  function Wc(t, e, l) {
    ...
    u.has(l) ||
      ((Xc = !0), u.add(l), (t = Vm.bind(null, t, e, l)), e.then(t, t));
  }
  function Vm(t, e, l) {
    var a = t.pingCache;
    (a !== null && a.delete(e),
    ...
    fr(function () {
      ...
      t: {
        ...
        if (E !== void 0) {
          ...
          0 < J.length &&
            ((E = new T(E, W, null, l, R)), N.push({ event: E, listeners: J }));
        }
      }
      if ((e & 7) === 0) {
        t: {
        ...
        ($ &&
          (mr &&
            ...
            (ta || $ !== 'onCompositionStart'
              ...
              : ((el = R),
                (xi = 'value' in el ? el.value : el.textContent),
                (ta = !0))),
          (at = Gn(_, $)),
          0 < at.length &&
            (($ = new dr($, t, null, l, R)),
...
`,
    ...
    switch (e) {
      ...
      case 'option':
        for (var W in l)
          if (
            ((E = l[W]),
            l.hasOwnProperty(W) && E != null && !a.hasOwnProperty(W))
          )
            switch (W) {
              case 'selected':
                t.selected = !1;
        ...
        for (d in a)
          if (
            ((E = a[d]),
            (T = l[d]),
            a.hasOwnProperty(d) && E !== T && (E != null || T != null))
          )
            switch (d) {
              case 'selected':
                t.selected =
      ...
      case 'menuitem':
        ...
        for (_ in a)
          if (
            ((E = a[_]),
            (T = l[_]),
            a.hasOwnProperty(_) && E !== T && (E != null || T != null))
          )
            switch (_) {
              case 'children':
              case 'dangerouslySetInnerHTML':
  ...
  function Ov(t, e, l, a, u) {
    switch (e) {
      ...
      case 'gotpointercapture':
        return (
          (n = u.pointerId),
          zu.set(n, Mu(zu.get(n) || null, t, e, l, a, u)),
          !0
        );
    }
    return !1;
  ...
  function Wn(t, e) {
    t.blockedOn === e &&
      ...
      _f ||
        ((_f = !0),
        c.unstable_scheduleCallback(c.unstable_NormalPriority, Nv)));
  }
  var Fn = null;
  function Od(t) {
    Fn !== t &&
...
function kv(c, s, o, r = {}) {
  ...
  function L(Z, B) {
    ...
    let P = Zd(tt, m),
      dt = w.createHref(tt);
    (A.replaceState(P, '', dt),
      g && p && p({ action: D, location: w.location, delta: 0 }));
  }
  function j(Z) {
    return Wv(Z);
  }
...
function kd(c, s = [], o = [], r = '') {
  let h = (g, A, D) => {
    ...
    (g.children &&
      ...
      kd(g.children, s, x, m)),
      !(g.path == null && !g.index) &&
        s.push({ path: m, score: ny(m, g.index), routesMeta: x }));
  };
  return (
    c.forEach((g, A) => {
...
function ny(c, s) {
  ...
  return (
    ...
    o
      .filter(h => !Vd(h))
      .reduce((h, g) => h + (Iv.test(g) ? ty : g === '' ? ly : ay), r)
  );
}
function iy(c, s) {
...
function ui(c, s) {
  ...
  return {
    params: r.reduce((m, { paramName: x, isOptional: q }, C) => {
      ...
      const L = D[C];
      return (
        q && !L ? (m[x] = void 0) : (m[x] = (L || '').replace(/%2F/g, '/')),
        m
      );
    }, {}),
    pathname: g,
...
function sy(c, s = '/') {
  let {
    ...
    search: r = '',
    hash: h = '',
  } = typeof c == 'string' ? Na(c) : c;
  return {
    pathname: o ? (o.startsWith('/') ? o : oy(o, s)) : s,
    search: my(r),
    hash: vy(h),
  };
}
  ...
  return (
    ...
    M.useCallback(
      (p, m = {}) => {
        ...
        (c == null &&
          s !== '/' &&
          (x.pathname = x.pathname === '/' ? s : ke([s, x.pathname])),
      ...
      w.map(B =>
        Object.assign({}, B, {
          ...
          pathname: ke([
            m,
            h.encodeLocation
              ? h.encodeLocation(B.pathname).pathname
              : B.pathname,
          ]),
          pathnameBase:
            B.pathnameBase === '/'
              ...
              : ke([
                  m,
                  h.encodeLocation
                    ? h.encodeLocation(B.pathnameBase).pathname
                    : B.pathnameBase,
                ]),
        }),
      ),
      ...
      A &&
        (D < 0 && x === 0
          ? (uh(
            ...
            (j = null))
          : D === x &&
            ((C = !0), (j = m.route.hydrateFallbackElement || null))));
  ...
  let {
    ...
    L = M.useMemo(() => {
      ...
      return j == null
        ? null
        : {
            location: { pathname: j, search: m, hash: x, state: q, key: C },
            navigationType: r,
          };
    }, [A, p, m, x, q, C, r]);
  return (
...
function n0({ page: c, matches: s, ...o }) {
  ...
  return M.createElement(
    ...
    C.map(j =>
      M.createElement('link', { key: j, rel: 'modulepreload', href: j, ...o }),
    ),
...
var fh = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Oa = M.forwardRef(function (
    ...
    if (typeof m == 'string' && w && ((Z = m), ch))
      try {
        let pt = new URL(window.location.href),
          ...
          he = We(Wt.pathname, j);
        Wt.origin === pt.origin && he != null
          ? (m = he + Wt.search + Wt.hash)
          : (B = !0);
      } catch {
        Ue(
          !1,
    ...
    return P && !w
      ? M.createElement(M.Fragment, null, Mt, M.createElement(a0, { page: tt }))
      : Mt;
  });
Oa.displayName = 'Link';
var f0 = M.forwardRef(function (
  ...
  let F = tt === B || (!h && tt.startsWith(B) && tt.charAt(dt) === '/'),
    Ut =
      P != null &&
      (P === B || (!h && P.startsWith(B) && P.charAt(B.length) === '/')),
                ...
                children: [
                  ...
                  U.jsxs('ul', {
                    children: [
                      ...
                      U.jsx('li', {
                        children: 'Customizable AI personalities',
                      }),
                    ],
                  }),
                ],
                ...
                children: [
                  ...
                  U.jsxs('div', {
                    ...
                    children: [
                      ...
                      U.jsx('p', {
                        children: 'Choose your preferred theme (coming soon)',
                      }),
                      U.jsx('div', {
                ...
                children: [
                  ...
                  U.jsxs('div', {
                    ...
                    children: [
                      ...
                      U.jsx('p', {
                        children:
                          'Configure AI providers and API keys (coming soon)',
                      }),
                      U.jsx('div', {
                        className: wt.placeholder,
                        children:
                ...
                children: [
                  ...
                  U.jsxs('div', {
                    ...
                    children: [
                      U.jsxs('p', {
                        children: [
                          U.jsx('strong', { children: 'Fishbowl' }),
                          ' v1.0.0',
                        ],
                      }),
                    ...
                    children: U.jsxs('div', {
                      ...
                      children: [
                        ...
                        U.jsxs('div', {
                          ...
                          children: [
                            U.jsx('div', {
                              className: zt.agentName,
                              children: 'Assistant',
                            }),
                            U.jsx('div', {
                              className: zt.agentStatus,
                              children: 'Ready',
                            }),
                          ],
                        }),
...
class Ag extends M.Component {
  ...
  componentDidCatch(s, o) {
    (console.error('Error caught by boundary:', s, o),
      this.setState({ error: s, errorInfo: o }));
  }
  render() {
