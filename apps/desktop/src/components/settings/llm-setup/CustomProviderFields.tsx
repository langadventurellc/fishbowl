...
export const CustomProviderFields: React.FC<CustomProviderFieldsProps> = ({
  ...
  return (
    <>
      ...
      {/* Base URL Field (Required for Custom) */}
      <FormField
        control={control}
        name="baseUrl"
        render={({ field }) => (
          <FormItem>
            ...
            <FormDescription>
              Required for custom providers. Enter the API endpoint URL.
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
        ...
        render={({ field }) => (
          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
            ...
            <div className="space-y-1 leading-none">
              ...
              <FormDescription>
                Enable if your provider expects the API key in the Authorization
                header
              </FormDescription>
            </div>
          </FormItem>
